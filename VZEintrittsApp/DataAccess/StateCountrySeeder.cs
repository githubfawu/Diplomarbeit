    ...
    public static class StateCountrySeeder
    {
        public static List<StateAndCountry> GetSeeds()
        {
            var list = new List<StateAndCountry>()
            {
                ...
                new StateAndCountry() {CityId = 11, CityName = "Genève", StateName = "Genève", CountryCode = "CH"},
                ...
                new StateAndCountry() {CityId = 20, CityName = "Neuchâtel", StateName = "Neuchâtel", CountryCode = "CH"},
