    ...
    public static class NumberFormatSeeder
    {
        public static List<NumberFormat> GetSeeds()
        {
            var list = new List<NumberFormat>()
            {
                ...
                new NumberFormat() { CityName = "Düsseldorf", Formats = new Dictionary<int, string>() {{2, " "}, {5, " "}, {9, " "}, {12, " "}}},
                new NumberFormat() { CityName = "Frankfurt am Main", Formats = new Dictionary<int, string>() {{2, " "}, {5, " "}, {8, " "}, {11, " "}, {14, " "}, {17, " "}}},
                ...
                new NumberFormat() { CityName = "London", Formats = new Dictionary<int, string>() {{2, " "}, {5, " "}, {9, " "}, {12, " "}}},
                ...
                new NumberFormat() { CityName = "Nürnberg", Formats = new Dictionary<int, string>() {{2, " "}, {6, " "}, {10, " "}, {13, " "}, {16, "-"}}},
